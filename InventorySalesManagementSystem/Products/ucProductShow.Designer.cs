namespace InventorySalesManagementSystem.Products
{
    partial class ucProductShow
    {
        ...
        private void InitializeComponent()
        {
            ...
            lbAvilable.TabIndex = 49;
            lbAvilable.Text = "----";
            lbAvilable.TextAlign = ContentAlignment.MiddleCenter;
            // 
            // lbID
            // 
            ...
            rtbQuantity.Size = new Size(162, 25);
            ...
            Controls.Add(label3);
            Controls.Add(lbSellingPrice);
            Controls.Add(label5);
            Controls.Add(lbAvilable);
            Controls.Add(lbID);
            Controls.Add(label9);
            Controls.Add(label1);
            Enabled = false;
